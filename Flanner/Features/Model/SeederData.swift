...
public let taskSeeds = [
  ...
  taskSeed(name: "Music Cafe Chilling",
           ...
           img: "musicCafeChilling", loc: "", tagNames: ["Indoor", "Music"]),
  ...
  taskSeed(name: "Binge Watch at Home",
           ...
           img: "bingeWatchAtHome", loc: "", tagNames: ["Indoor", "Movie"]),
  ...
  taskSeed(name: "Poetry Class",
           ...
           img: "poetryClass", loc: "", tagNames: ["Indoor", "Art"]),
  ...
  taskSeed(name: "ATV Riding",
           ...
           img: "atvRiding", loc: "", tagNames: ["Outdoor", "Adrenaline", "Nature"]),
